...
> While installing this command you may see few **warnings**, don't worry about that for more details refer to our FAQ npm [install warnings](https://demos.themeselection.com/sneat-bootstrap-html-admin-template/documentation/faq.html#install-warnings).
...
> **Tip:** Use `yarn run/npm run` command to list all predefined npm tasks from `package.json` file.
